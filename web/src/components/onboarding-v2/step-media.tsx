...
export function StepMedia({
  ...
  return (
    <div>
      <StepHead
        eyebrow="Step 3 · Media network"
        title="Your audience reads these outlets"
        subtitle={`Based on “${brand.category.value}” in ${brand.region.join(" · ")}, Cortex identified ${mediaNetwork.length} highly relevant outlets and pre-matched each with a Context Agent.`}
        accent="Analysis complete · live"
      />
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    {m.weeklyReaders != null ? `${m.weeklyReaders}/wk` : "—"}
                  </span>
                </div>
              </button>
            );
        ...
        <Card style={{ padding: 18, position: "sticky", top: 100 }}>
          ...
          {competitorList.length ? (
            ...
            >
              ...
              <strong>{competitorList.slice(0, 3).join(", ")}</strong> appeared in these
              outlets a combined <strong>286 times</strong> this week.
            </div>
          ) : null}
        </Card>
      </div>
