...
import { StepRail, TopBar } from "@/components/onboarding-v2/primitives";
import type { RailIndex } from "@/components/onboarding-v2/data";
...
describe("onboarding-v2 primitives — TopBar (Light Edition)", () => {
...
describe("onboarding-v2 primitives — StepRail (Light Edition)", () => {
