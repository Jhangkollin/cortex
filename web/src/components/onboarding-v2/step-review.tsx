    ...
    return (
      <div style={{ display: "flex", alignItems: "flex-start", gap: 6 }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            {value || (
              <span style={{ color: "var(--mly-ink-400)", fontStyle: "italic" }}>— Not set —</span>
            )}
          </div>
        </div>
        <button
...
export function StepReview({
  ...
  const summary: Array<{
    ...
    { l: "Products", v: productsOn, t: brand.products.length, i: "category" },
    { l: "Voice samples", v: voiceOn, t: brand.voiceSamples.length, i: "campaign" },
    { l: "Competitors", v: competitorsOn, t: brand.competitors.length, i: "groups" },
    { l: "Regions", v: brand.region.length, t: null, i: "place" },
    {
      l: "Category confidence",
  ...
  return (
    <div>
      <StepHead
        eyebrow="Step 2 · Confirm data"
        title="Here's what we found — take a quick look"
        subtitle="Every field is editable. Click the pencil next to anything that's off. Once you confirm, Cortex uses this profile to analyze your media network and the questions readers are asking this week."
        accent={`From ${brand.url} · 25 seconds ago · 47 source signals`}
      />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
        ...
        <Card style={{ padding: 18 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
            ...
            <Badge color="amber" style={{ marginLeft: "auto" }}>
              {brand.category.confidence}% confidence
            </Badge>
          </div>
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <button
                type="button"
                aria-label="Swap primary category"
                style={{
                  background: "transparent",
                  border: "none",
                  padding: 0,
        ...
        <Card style={{ padding: 18, gridColumn: "1 / -1" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
            ...
            <div style={{ fontSize: 13, fontWeight: 700, color: "var(--mly-ink-900)" }}>
              Products (selected items will be used to answer questions)
            </div>
            <span style={{ fontSize: 11, color: "var(--mly-ink-500)" }}>
              {productsOn} / {brand.products.length} active
            </span>
          ...
          {brand.productMoreCount > 0 ? (
            ...
            >
              <Icon name="unfold_more" size={14} /> Show {brand.productMoreCount} more products
            </button>
          ) : null}
        </Card>
        ...
        <Card style={{ padding: 18 }}>
          ...
          <div style={{ fontSize: 12, color: "var(--mly-ink-500)", marginBottom: 12 }}>
            Pick the lines that sound most like you. Cortex uses these to build your tone
            fingerprint.
          </div>
        ...
        <Card style={{ padding: 18 }}>
          ...
          <div style={{ fontSize: 12, color: "var(--mly-ink-500)", marginBottom: 12 }}>
            Cortex tracks these brands across your media network and alerts you when
            opportunities slip.
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            >
              <Icon name="add" size={14} /> Add competitor
            </button>
          </div>
        </Card>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: 13, color: "var(--mly-ink-800)", lineHeight: 1.55 }}>
          <strong style={{ color: "var(--mly-ink-900)" }}>Next:</strong> Cortex will use
          this profile to map your{" "}
          <strong style={{ color: "var(--mly-teal-700)" }}>media network</strong> and the{" "}
          <strong style={{ color: "var(--mly-teal-700)" }}>questions readers are asking</strong>{" "}
          this week. You can always come back and adjust from Settings.
        </div>
